...
<div class="topbar">
    <div class="topbar-inner">
        <div class="container">
            ...
            <?php if ($this->Session->user('Taches')) : ?>
                <p class="text-warning"><p class="text-right"><a href="<?php echo Router::url('taches/validate'); ?>">Vous
                        avez <?php echo $this->Session->user('Taches');
                        echo ($this->Session->user('Taches') > 1) ? ' nouvelles tâches' : ' nouvelle tâche';?></a>
                </p></p>
            <?php endif; ?>
